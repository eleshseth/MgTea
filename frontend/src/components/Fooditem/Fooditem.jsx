...
const Fooditem = ({ id, name, price, images, stock, discount }) => {
  // Add discount prop
  ...
  const displayImage = images && images.length > 0 ? images[0] : assets.food_1;
  ...
  return (
    <div className={`main-container ${isOutOfStock ? 'out-of-stock' : ''}`}>
      <div className='food-item'>
        <div
          ...
          <img
            ...
            src={imgError ? assets.food_1 : displayImage}
            alt={name}
      ...
      <p className='food-item-price' dir='ltr'>
        {hasDiscount && <span className='original-price'>₹{price}</span>}
        <b>₹</b>
