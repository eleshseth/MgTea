    ...
    <div className='contact-container' id='contact'>
      <div className='contact-left'>
        ...
        <p>
          ...
          teas, need help with an order, or just want to share your feedback,
          the MG India team is here for you.
        </p>
        ...
        <div className='contact-info'>
          <div className='contact-item'>
            ...
            <div>
              <h3>Address</h3>
              <p>Kaushambi, Ghaziabad Uttar Pradesh 201010</p>
            </div>
          </div>
